...
<div class="container-fluid">
	...
	<form method="POST" action="<?php echo base_url('admin/laporan_absensi/cetak_laporan_absensi_harian')?>">
		<div class="card-body">
			<button style="width: 100%" type="submit" class="btn btn-primary"><i class="fas fa-print"></i>  Cetak Laporan Absensi Hari Ini</button>
		</div>
	</form>
</div>
<!-- /.container-fluid -->