...
<div class="container-fluid">
  ...
  <div class="card-body">
	...
	<table class="table table-bordered table-striped">
		...
		<?php $no=1; foreach($input_hadir as $h) :?>
			<tr>
				<input type="hidden" name="bulan[]" class="form-control" value="<?php echo $bulantahun?>">
				<input type="hidden" name="nik[]" class="form-control" value="<?php echo $h->nik?>">
				<input type="hidden" name="nama_pegawai[]" class="form-control" value="<?php echo $h->nama_pegawai?>">
				<input type="hidden" name="jenis_kelamin[]" class="form-control" value="<?php echo $h->jenis_kelamin?>">
				<input type="hidden" name="nama_jabatan[]" class="form-control" value="<?php echo $h->nama_jabatan?>">
				...
				<td><input type="number" name="hadir[]" class="form-control" value="<?php echo $h->hadir; ?>"></td>
				<td><input type="number" name="sakit[]" class="form-control" value="<?php echo $h->sakit?>"></td>
				<td><input type="number" name="alpha[]" class="form-control" value="<?php echo $h->alpha?>"></td>
		<?php endforeach; ?>
	</table><br></br><br></br>
	</form>
